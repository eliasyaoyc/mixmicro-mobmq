...
public class ConfigOption<T> {
   ...
   * Configuration#getValue(ConfigOption)}, the fallback keys will be checked in the order provided
   * to this method. The first key for which a value is found will be used - that value will be
   * returned.
   *
