...
import static xyz.vopen.framework.scheduler.core.configuration.StructuredOptionsSplitter.escapeWithSingleQuote;
 ...
 */
public class Configuration<T> implements ReadableConfig {
  ...
  public void addAll(Configuration other, String prefix) {
    ...
    synchronized (this.confData) {
      synchronized (other.confData) {
        other.confData.forEach(
            (key, value) -> {
              bld.setLength(pl);
              bld.append(key);
              this.confData.put(bld.toString(), value);
            });
      }
    }
  }
