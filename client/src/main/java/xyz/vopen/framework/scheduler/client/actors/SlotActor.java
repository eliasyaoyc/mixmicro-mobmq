...
import xyz.vopen.framework.scheduler.client.model.request.TaskStartRequest;
import xyz.vopen.framework.scheduler.client.model.request.TaskStopRequest;

/**
 * {@link SlotActor} Real Processor node that process requests from {@link
 * xyz.vopen.framework.scheduler.client.taskmaster.TaskManager}.
 *
